...
HUB_MQTT_TOPIC = os.environ.get("HUB_MQTT_TOPIC") or "agent_data_topic"
HUB_MQTT_PROCESSED_TOPIC=os.environ.get("HUB_MQTT_PROCESSED_TOPIC" or "processed_agent_data_topic")
